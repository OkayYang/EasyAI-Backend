...
import com.easyai.system.domain.SysUserOnline;
import com.easyai.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    {
        Collection<String> keys = redisService.keys(CacheConstants.ADMIN_LOGIN_TOKEN_KEY + "*");
    ...
    {
        redisService.deleteObject(CacheConstants.ADMIN_LOGIN_TOKEN_KEY + tokenId);
        return success();
    }
}
