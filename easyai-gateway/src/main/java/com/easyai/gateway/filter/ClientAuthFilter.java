package com.easyai.gateway.filter;
...
import com.easyai.common.core.constant.TokenConstants;
...
import com.easyai.gateway.config.properties.IgnoreWhiteProperties;
 ...
 */
@Component
public class ClientAuthFilter implements GlobalFilter, Ordered
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        if (claims == null)
        {
            return unauthorizedResponse(exchange, "解析登录凭证失败!");
        }
    ...
    {
        return CacheConstants.CLIENT_LOGIN_TOKEN_KEY + token;
    }
